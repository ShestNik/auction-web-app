...
class Lot(models.Model):
	...
	def is_selling(self, user):
		print(user, self.dj_owner_id, self.is_sold == False)
		return user == self.dj_owner_id and self.is_sold == False

	def is_already_sold(self, user):
		print(user, self.dj_owner_id, self.is_sold == True)
		return user == self.dj_owner_id and self.is_sold == True

	def is_won(self, user):
		print(user, self.cur_customer_id, self.is_sold == True)
